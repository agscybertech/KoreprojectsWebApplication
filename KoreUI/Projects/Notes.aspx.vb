...
Partial Class Projects_Notes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dsNotes = m_ManagementService.GetUserNotesByUserIDUserProjectStatusValue(CInt(m_Cryption.Decrypt(Request.QueryString("id"), m_Cryption.cryptionKey)), UserProjectStatusValue)
