<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlPrintScopesApprovedGrid.ascx.vb" Inherits="WebControls_WebUserControlPrintScopesApprovedGrid" %>
<asp:GridView ID="gvScopesApproved" runat="server" AllowPaging="false" 
    ...
    Width="100%">
    <Columns>
        <asp:BoundField DataField="Area" HeaderText="AREA" SortExpression="Area" ItemStyle-Width="100"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="btnDisapprove" runat="server" 
                                CommandArgument='<%# string.format("{0},{1}",m_Cryption.encrypt(Eval("ScopeID", "{0}"),m_Cryption.cryptionKey),m_Cryption.encrypt(Eval("ScopeItemID", "{0}"),m_Cryption.cryptionKey)) %>' 
                                onclick="btnDisapprove_Click">DISAPPROVE</asp:LinkButton>
                        </td>
                    </tr>
                </table>                
            </ItemTemplate>
