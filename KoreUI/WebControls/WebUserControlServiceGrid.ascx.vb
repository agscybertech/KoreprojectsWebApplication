...
Partial Class WebControls_WebUserControlServiceGrid
    ...
    Private Sub LoadAreaData()
        ...
        dsService = m_ScopeService.GetWorksheetServicesByProjectOwnerId(m_CompanyId)
        gvService.DataSource = dsService.Tables(0)
        gvService.DataBind()
    End Sub

    Protected Sub gvService_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvService.DataBound
        ' Retrieve the pager row.
        Dim pagerRow As GridViewRow = gvService.BottomPagerRow
        ...
        If Not pageList Is Nothing Then
            ...
            For i = 0 To gvService.PageCount - 1
        ...
        If Not pageLabel Is Nothing Then
            ...
            Dim currentPage As Integer = gvService.PageIndex + 1

            ' Update the Label control with the current page information.
            pageLabel.Text = "Showing Page: " & currentPage.ToString() & _
                " of " & gvService.PageCount.ToString()

        End If

        If gvService.Rows.Count > 0 Then
            If gvService.PageIndex = 0 Then
                If Not pagePre Is Nothing Then
                    pagePre.Visible = False
                End If
            ElseIf gvService.PageCount - 1 = gvService.PageIndex Then
    ...
    Protected Sub gvService_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles gvService.PageIndexChanging
    ...
    Protected Sub gvService_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles gvService.Sorting
        GridViewSortExpression = e.SortExpression
        Dim pageIndex As Integer = gvService.PageIndex
        LoadAreaData()
        gvService.DataSource = SortDataTable(gvService.DataSource, False)
        gvService.DataBind()
    ...
    Protected Sub lbnPre_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Dim PrePage As Integer = gvService.PageIndex - 1
        gvService.PageIndex = PrePage
        LoadAreaData()
    End Sub

    Protected Sub lbnNext_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Dim NextPage As Integer = gvService.PageIndex + 1
        gvService.PageIndex = NextPage
        LoadAreaData()
    End Sub
    ...
    Protected Sub ddlPages_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        gvService.PageIndex = pageList.SelectedIndex

        LoadAreaData()
        gvService.DataSource = SortDataTable(gvService.DataSource, True)
        gvService.DataBind()
    End Sub
End Class
