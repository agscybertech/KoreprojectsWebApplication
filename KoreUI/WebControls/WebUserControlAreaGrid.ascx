<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlAreaGrid.ascx.vb" Inherits="WebControls_WebUserControlAreaGrid" %>
<asp:GridView ID="gvArea" runat="server" AllowPaging="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="ACTION">
            ...
            <ItemTemplate>
                <a class="form_popup" href="Area.aspx?id=<%# m_Cryption.encrypt(Eval("AreaId", "{0}"),m_Cryption.cryptionKey) & string.format("&{0}",Datetime.Now.ToString("yyyyddMMhhmmss")) %>" style="text-decoration:none;">EDIT</a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
