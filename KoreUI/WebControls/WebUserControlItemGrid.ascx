<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlItemGrid.ascx.vb" Inherits="WebControls_WebUserControlItemGrid" %>
<asp:GridView ID="gvItem" runat="server" AllowPaging="false" 
    ...
    Width="100%">
    <Columns>
        <asp:BoundField DataField="Name" HeaderText="Item" SortExpression="Name" ItemStyle-Width="140" ItemStyle-HorizontalAlign="left" />
        <asp:TemplateField HeaderText="ACTION">
            <ItemStyle HorizontalAlign="Center" Width="40" />
            <ItemTemplate>
                <a class="form_popup" href="Item.aspx?id=<%# m_Cryption.encrypt(Eval("ItemId", "{0}"),m_Cryption.cryptionKey) & string.format("&{0}",Datetime.Now.ToString("yyyyddMMhhmmss")) %>" style="text-decoration:none;">EDIT</a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
