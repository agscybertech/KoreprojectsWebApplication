<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlReOrderGrid.ascx.vb" Inherits="WebControls_WebUserControlReOrderGrid" %>
<asp:GridView ID="gvReOrder" runat="server" AllowPaging="True" 
    ...
    Width="100%">
    <Columns>
        <asp:BoundField DataField="JobName" HeaderText="Project" SortExpression="JobName" ItemStyle-Width="140" ItemStyle-HorizontalAlign="left" />
       <%-- <asp:TemplateField HeaderText="Assignee">
        ...
        <asp:BoundField DataField="ReOrderBy" HeaderText="ReOrder By" SortExpression="ReOrderBy" ItemStyle-Width="140" ItemStyle-HorizontalAlign="left" />
        <asp:BoundField DataField="ReOrder" HeaderText="ReOrder Items" SortExpression="ReOrder" ItemStyle-Width="140" ItemStyle-HorizontalAlign="left" />

        <asp:BoundField DataField="CreatedDate" HeaderText="ReOrder Date" SortExpression="CreatedDate" DataFormatString="{0:ddd dd/MM/yyyy}" HtmlEncode="False"  ItemStyle-Width="160" />
