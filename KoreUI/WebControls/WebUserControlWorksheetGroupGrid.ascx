<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlWorksheetGroupGrid.ascx.vb" Inherits="WebControls_WebUserControlWorksheetGroupGrid" %>
<asp:GridView ID="gvWorksheetGroup" runat="server" AllowPaging="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="ACTION">
            ...
            <ItemTemplate>
                <a class="form_popup" href="WorksheetGroup.aspx?id=<%# m_Cryption.encrypt(Eval("WorksheetGroupId", "{0}"),m_Cryption.cryptionKey) & string.format("&{0}",Datetime.Now.ToString("yyyyddMMhhmmss")) %>" style="text-decoration:none;">EDIT</a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
