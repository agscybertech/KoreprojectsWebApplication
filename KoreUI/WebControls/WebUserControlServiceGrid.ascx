<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlServiceGrid.ascx.vb" Inherits="WebControls_WebUserControlServiceGrid" %>
<asp:GridView ID="gvService" runat="server" AllowPaging="false" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="ACTION">
            ...
            <ItemTemplate>
                <a class="form_popup" href="WorksheetService.aspx?id=<%# m_Cryption.encrypt(Eval("WorksheetServiceId", "{0}"),m_Cryption.cryptionKey) & string.format("&{0}",Datetime.Now.ToString("yyyyddMMhhmmss")) %>" style="text-decoration:none;">EDIT</a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
