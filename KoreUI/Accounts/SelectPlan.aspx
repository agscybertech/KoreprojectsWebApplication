<%@ page title="" language="VB" masterpagefile="~/Projects/MasterPage.master" autoeventwireup="false" inherits="Accounts_SelectPlan" CodeFile="SelectPlan.aspx.vb" %>
    ...
    <tr>
		<td align="left">
            ...
            <ItemTemplate>
                    <tr>
                        <td>
                            <asp:CheckBox ID="cbServicePlan" Runat="server" Enabled="True" EnableViewState="true" Text='<%#DataBinder.Eval(Container, "DataItem.Name")%>'></asp:CheckBox>                            
                            ...
                            <asp:TextBox ID="txtNumberOfProjectCredits" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.NumberOfProjects")%>' Visible="false"></asp:TextBox>
                        </td>
                        <td align="right">
        ...
        <td align="center">
            <table style="width: 100%">
			    <tr>
				    ...
				    <td style="width: 50%" align="right"><span class="Apple-converted-space"><asp:Button ID="btnPay" runat="server" Text="Pay Now"/></span></td>
			    </tr>
		    </table>
        </td>
    </tr>
