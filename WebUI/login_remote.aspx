<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login_remote.aspx.vb" Inherits="login_remote" %>
...
<body>
    ...
    <div id="content" align="left">
        <table cellpadding="4" cellspacing="4" align="center" style="margin-top:60px"> 
            ...
            <tr>
                <td align="center">
                    <asp:HyperLink ID="hlkForgottenPassward" runat="server" NavigateUrl="ForgotPassword.aspx" Target="_top">Forgotten your password?<br/>CLICK HERE</asp:HyperLink>
                </td>
            </tr>
        </table>
    </div>
