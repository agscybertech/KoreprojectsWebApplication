...
Partial Class Accounts_Plans
    ...
    Protected Sub ibtnPay_Click(sender As Object, e As ImageClickEventArgs) Handles ibtnPay.Click
        Try
            ...
            paymentDefinition.frequency = "DAY" 'TODO:Change to month
            ...
            agreement.start_date = TimeZoneInfo.ConvertTime(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("New Zealand Standard Time")).AddDays(1).ToString("yyyy-MM-ddThh:mm:ssZ")  'TODO:Change to AddMonths
            ...
            If rbCreditCard.Checked Then
                If Not createdAgreement.id Is Nothing Then
                    ...
                    If createdAgreement.state.ToLower() = "active" AndAlso _
                        Not createdAgreement.agreement_details Is Nothing AndAlso _
                        Not createdAgreement.agreement_details.last_payment_amount Is Nothing AndAlso _
