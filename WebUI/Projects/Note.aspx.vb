...
Partial Class Projects_Note
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If m_CurrentNoteID > 0 Then
                ...
                dsUserFile = m_ManagementService.GetUserNoteByUserNoteID(m_CurrentNoteID)
                ...
                lblNote.Text = "UPDATE NOTE"
            Else
                btnUpdate.Visible = False
                btnAdd.Visible = True
                btnDelete.Visible = False
                lblNote.Text = "ADD NOTE"
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If m_ProjectID > 0 Then
            ...
            m_ManagementService.CreateUserNote(CurrentNote)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        If m_CurrentNoteID > 0 And m_ProjectID > 0 Then
            ...
            CurrentNote.NoteContent = tbxMessage.Text.Trim
            CurrentNote.ProjectStatusId = ddlProjectStatus.SelectedValue
            m_ManagementService.UpdateUserNote(CurrentNote)
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If m_CurrentNoteID > 0 And m_ProjectID > 0 Then
            m_ManagementService.DeleteUserNoteByUserNoteIDOwner(m_CurrentNoteID, m_ProjectID)
