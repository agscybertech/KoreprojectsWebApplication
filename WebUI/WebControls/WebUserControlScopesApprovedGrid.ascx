<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlScopesApprovedGrid.ascx.vb" Inherits="WebControls_WebUserControlScopesApprovedGrid" %>
<asp:Repeater ID="rptScopesApproved" runat="server">
    <ItemTemplate>
