<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WebUserControlProjectStatusGrid.ascx.vb" Inherits="WebControls_WebUserControlProjectStatusGrid" %>
<asp:GridView ID="gvProjectStatus" runat="server" AllowPaging="false" 
    ...
    Width="100%">
    <Columns>
        <asp:BoundField DataField="Name" HeaderText="Project Status" SortExpression="Name" ItemStyle-Width="140" ItemStyle-HorizontalAlign="left" />
        ...
        <asp:TemplateField HeaderText="ACTION">
            ...
            <ItemTemplate>
                <a class="form_popup" href="ProjectStatusSetting.aspx?id=<%# m_Cryption.encrypt(Eval("UserProjectStatusSettingId", "{0}"),m_Cryption.cryptionKey) & string.format("&{0}",Datetime.Now.ToString("yyyyddMMhhmmss")) %>" style="text-decoration:none;">EDIT</a>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
