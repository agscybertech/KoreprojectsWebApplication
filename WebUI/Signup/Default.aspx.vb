    ...
    Protected Sub btnSignup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSignup.Click
        If m_ManagementService.GetUserCountByEmail(txtUser.Text) = 0 Then
            ...
            If Not m_LoginUser Is Nothing Then
                ...
                Else
                    If numberOfProjects = 1 Then
                        MailMessage.Body = String.Format("Hi there,<br><br>Welcome to Kore Projects.<br><br>Your account has been activated with {0} project.<br>To visit Kore Projects please use the link below:<br><br>http://{1}<br><br>The Kore Projects Team", numberOfProjects, Request.Url.Authority)
                    Else
                        MailMessage.Body = String.Format("Hi there,<br><br>Welcome to Kore Projects.<br><br>Your account has been activated with {0} projects.<br>To visit Kore Projects please use the link below:<br><br>http://{1}<br><br>The Kore Projects Team", numberOfProjects, Request.Url.Authority)
                    End If
                End If
                ...
                Else
                    ...
                    'Response.Redirect("..\Contacts\ProjectOwnerDetail.aspx")
                    Response.Redirect("../Contacts/ProjectOwnerDetail.aspx")
                End If
            Else
                lblErrorMessage.Text = "The email is already used."
            End If
        Else
            lblErrorMessage.Text = "The email is already used."
        End If
