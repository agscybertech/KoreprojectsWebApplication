<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WorksheetService.aspx.vb" Inherits="Contacts_WorksheetService" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Worksheet Service</title>
...
<body>
    ...
    <div>
        <table style="width: 90%" align="center" cellpadding="4" cellspacing="4">
	        <tr>
		        <td align="left"><h1 id="appointment"><asp:Label ID="lblWorksheetService" runat="server" Text=""></asp:Label></h1></td>
	        </tr>
	        <tr>
		        <td align="center">
		        <table style="width: 600px" align="center" cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                        <td align="left">
                            <asp:TextBox ID="txtWorksheetService"
                            maxlength="100" runat="server" width="180" TabIndex="10"></asp:TextBox>                            
                        </td>
                        <td align="left">
                            <asp:DropDownList ID="ddlUnit" runat="server" width="150" TabIndex="7">
                            </asp:DropDownList>                            
                        </td>
                        <td align="left">
	        ...
	        <tr>
		        <td>
                <asp:RequiredFieldValidator ID="rfvWorksheetService" runat="server" Enabled="false" ErrorMessage="Name is required." ControlToValidate="txtWorksheetService" Display="None"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="revWorksheetService" runat="server" ControlToValidate="txtWorksheetService" Display="None" ErrorMessage="Name is not valid, and no more than 40 characters allows." ValidationExpression="^.{1,40}$"></asp:RegularExpressionValidator>
                ...
                <asp:ValidationSummary ID="vsWorksheetService" ShowMessageBox="true" ShowSummary="false" HeaderText="You must correct error in the following fields:" EnableClientScript="true" runat="server"/>
		        <table style="width: 100%">
			        <tr>
				        <td style="width: 50%"><span class="Apple-converted-space"><asp:Button ID="btnDelete" runat="server" 
                                Text="Delete" CausesValidation="False" OnClientClick="return confirm('Are you sure you want to delete this service?');" TabIndex="30" />&nbsp;</span></td>
