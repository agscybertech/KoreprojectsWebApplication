...
Partial Class Contacts_OwnerSetting
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        WorksheetGroupGrid.CompanyId = m_LoginUser.CompanyId
        AreaGrid.CompanyId = m_LoginUser.CompanyId
        ItemGrid.CompanyId = m_LoginUser.CompanyId
        WorksheetServiceGrid.CompanyId = m_LoginUser.CompanyId
