...
Partial Class Contacts_Timesheet
    ...
    Private isTimesheetEntryEdit As Boolean
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not isValidID AndAlso Not Request.QueryString("TimeSheetEntryID") Is Nothing Then
            If Integer.TryParse(Request.QueryString("TimeSheetEntryID"), intTimeSheetEntryID) Then
                isValidID = True
                isTimesheetEntryEdit = True
            End If
        End If
        ...
        If isValidID Then
            ...
            If Not IsPostBack Then
                ...
                If m_Timesheet.WorkStart <> Nothing And m_Timesheet.WorkEnd <> Nothing Then
                    lblThour.Text = String.Format("{0}", DateDiff(DateInterval.Minute, m_Timesheet.WorkStart, m_Timesheet.WorkEnd) / 60)
                    If m_Timesheet.LunchStart <> Nothing And m_Timesheet.LunchEnd <> Nothing Then
                        lblThour.Text = String.Format("{0}", (DateDiff(DateInterval.Minute, m_Timesheet.WorkStart, m_Timesheet.WorkEnd) - DateDiff(DateInterval.Minute, m_Timesheet.LunchStart, m_Timesheet.LunchEnd)) / 60)
                    End If
                End If
            End If
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                ViewState("PreviousPageUrl") = "~/Print/Timesheets.aspx"
            End If
        End If
